...
export const SOCKET_CONNECTION_DISCONNECT = 'SOCKET_CONNECTION_DISCONNECT';

export const NEW_CHAT_EVENT = 'NEW_CHAT_EVENT';
export const DELETED_CHAT_EVENT = 'DELETED_CHAT_EVENT';
export const SEND_MESSAGE_EVENT = 'SEND_MESSAGE_EVENT';
export const NEW_MESSAGE_EVENT = 'NEW_MESSAGE_EVENT';
export const MOUNT_CHAT_EVENT = 'MOUNT_CHAT_EVENT';
export const UNMOUNT_CHAT_EVENT = 'UNMOUNT_CHAT_EVENT';
