...
export const getActiveChat = createSelector([getChats, getActiveChatId], (chats, activeChatId) =>
  chats.find(chat => chat._id === activeChatId));

export const isMember = createSelector([getUser, getActiveChat], (currentUser, activeChat) => {
...
export const isCreator = createSelector([getUser, getActiveChat], (currentUser, activeChat) => {
  if (!activeChat || !currentUser) {
    return false;
  }
